...
\section{General idea} \label{sec:challenges}
   ...
   use of synchronized rounds across all partitions allow a deterministic transactions ordering. As a result, partitions can not directly order transactions delivered by {\GE} and {\PE}, as is illustrated in Figure
   ...
   timestamp. As such, a partition can order all transactions simply by their timestamps, as in {\GE}.
